...
export const PROJECTS: Project[] = [
  { id: "research-pm", name: "Research PM", color: "text-cyan-400", colorBg: "bg-cyan-500" },
  { id: "research-project-pm", name: "Research Project PM", color: "text-teal-400", colorBg: "bg-teal-500" },
  { id: "siso-internal-pm", name: "SISO Internal PM", color: "text-orange-400", colorBg: "bg-orange-500" },
  { id: "legacy", name: "Legacy", color: "text-red-400", colorBg: "bg-red-500" },
  { id: "ecom", name: "Ecom", color: "text-green-400", colorBg: "bg-green-500" },
  { id: "saas", name: "SaaS", color: "text-blue-400", colorBg: "bg-blue-500" },
  { id: "twitter-pm", name: "Twitter PM", color: "text-sky-400", colorBg: "bg-sky-500" },
];
