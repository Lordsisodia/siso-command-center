...
const MOCK_AGENTS: AgentState[] = [
  {
    agentId: "pm-siso-internal",
    name: "PM - SISO Internal",
    sessionKey: "pm-siso-internal",
    status: "idle",
  ...
  },
  {
    ...
    toolCallingEnabled: true,
    showThinkingTraces: false,
    avatarSeed: "pm-research",
    project: "blackbox5",
  },
  {
    agentId: "planner-blackbox5",
    name: "Planner - Stories",
    sessionKey: "planner-blackbox5",
    status: "running",
    sessionCreated: true,
    awaitingUserInput: false,
    hasUnseenActivity: false,
  ...
  {
    agentId: "static-lumelle",
    name: "Static Analysis",
    sessionKey: "static-lumelle",
    status: "idle",
    sessionCreated: false,
    awaitingUserInput: false,
    hasUnseenActivity: false,
